  ...
  return <div className="h-24 px-8 flex justify-between items-center relative">
    ...
    <Menu as="div" className="h-12 relative">
      <Menu.Button
        ...
        <img src={user.avatar_url || "/images/avatar-default.jpg"} alt="avatar"
             className="w-12 h-12 object-cover rounded-full opacity-80 group-hover:opacity-90 group-focus:ring-4 group-focus:ring-gray-300"/>
      </Menu.Button>
      <Transition
        as={Fragment}
        enter="transition ease-out duration-100"
