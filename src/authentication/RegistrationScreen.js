...
const RegistrationScreen = ({onSuccess}) => {
  ...
  return <>
    <div className="w-full md:h-full py-8 md:p-0 md:flex justify-between items-stretch sm:rounded-xl bg-white shadow overflow-hidden">
    ...
    >
      <div className="absolute bottom-0 px-6 py-3 shadow rounded-xl bg-red-100 text-red-500">{JSON.stringify(error)}</div>
    </Transition>
  </>;
}
